...
class Game:
    ...
    def __init__(self):
        self.width = 800 #to be properties of game class
        self.height = 800
    ...
    def reset_map(self):
        self.player = Player(375, 700, 50, 50, 'assets/player.png', 6)
        ...
        if self.level >= 6.0:
            self.enemies = {
                ...
                Enemy(400, 400, 50, 50, 'assets/enemy.png', speed),
                Enemy(750, 200, 50, 50, 'assets/enemy.png', speed),
                Enemy(200, 500, 50, 50, 'assets/enemy.png', speed),
                Enemy(600, 300, 50, 50, 'assets/enemy.png', speed),
            }
        elif self.level >= 4.0:
            self.enemies = {
                Enemy(0, 600, 50, 50, 'assets/enemy.png', speed),
    ...
    def draw_objects(self):
        ...
        self.game_window.blit(self.background.image, (self.background.x, self.background.y)) #(x,y) 0,0 is top left
    ...
    def detect_collision(self, object_1, object_2):
        if object_1.y > (object_2.y + object_2.height): #1 below 2
            return False
        elif (object_1.y + object_1.height) < object_2.y: #1 above 2
            return False
        ...
        while True: #runs until break statement
            ...
            for event in events:
                if event.type == pygame.QUIT:
                    return #break out of entire game loop
            ...
            self.clock.tick(60) #60 times per second